...
# print output
  for j in range(0,max_part_index):
    ...
    fileout.write("#pT       <dN/(2 pT dpT)>      <v2>     <v3>\n")
    for i in range(0,npt):
...
np.savez_compressed(fileout,Q2cos_item=Q2cos, Q2sin_item=Q2sin, Q3cos_item=Q3cos, Q3sin_item=Q3sin, M_item=M, nump_item=nump, dpt_item=dpt, p2cos_item=p2cos, p2sin_item=p2sin, p3cos_item=p3cos, p3sin_item=p3sin,nevents_item=nevents)
fileout.close()
